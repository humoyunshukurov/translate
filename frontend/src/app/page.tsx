...
// Backend build vaqtida mavjud bo'lmasligi mumkin → har so'rovda render qilinsin
...
export default async function Home() {
  ...
  try {
    ...
    // Backend unavailable — bo'sh ro'yxat ko'rsatamiz
  }
    ...
    <main className="max-w-2xl mx-auto px-4 py-12">
      ...
      {topics.length === 0 ? (
        <div className="text-center py-12 text-gray-400">
          ...
          <p>Topics are loading or backend is not connected.</p>
        </div>
      ) : (
